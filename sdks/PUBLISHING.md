...
| --- | --- | --- | --- | --- | --- |
| Browser | `sdks/js` | npm | `@edraj/sauron-browser` | 1.2.0 | `sauron.javascript` |
| Node | `sdks/node` | npm | `@edraj/sauron-node` | 1.2.0 | `sauron-node` |
| Python | `sdks/python` | PyPI | `sauron-sdk` | 1.2.0 | `sauron-python` |
| C# | `sdks/csharp` | NuGet | `Sauron` | 1.2.0 | `sauron-dotnet` |
| Flutter | `sdks/flutter` | pub.dev | `sauron_flutter` | 1.3.0 | `sauron.flutter` |
