<script lang="ts">
  ...
  // This page used an inline `() => void load(true)` handler, which forced the
  // client cache but never the server's and reported completion the instant the
  // call was made rather than when it landed.
