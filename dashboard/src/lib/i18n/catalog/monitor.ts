...
export const monitor = {
  ...
  // The day-detail modal opened by clicking a bar on either chart above.
  'perf.day.lede': {
    en: 'All 24 hours of this day, in your local time.',
    ar: 'جميع ساعات هذا اليوم الأربع والعشرين، بتوقيتك المحلي.',
  },
  'perf.day.chartLabel': {
    en: 'Latency and throughput by hour',
    ar: 'زمن الاستجابة والإنتاجية حسب الساعة',
  },
  'perf.day.latency': { en: 'p95 latency', ar: 'زمن الاستجابة p95' },
  'perf.day.throughput': { en: 'Transactions', ar: 'المعاملات' },
  'perf.day.noData': { en: 'Not measured', ar: 'غير مُقاس' },
  'perf.day.alsoThroughput': { en: 'Also show throughput', ar: 'إظهار الإنتاجية أيضاً' },
  'perf.day.alsoLatency': { en: 'Also show latency', ar: 'إظهار زمن الاستجابة أيضاً' },
  'perf.day.transactions': { en: 'Transactions', ar: 'المعاملات' },
  'perf.day.peakP95': { en: 'Peak p95', ar: 'أعلى p95' },
  'perf.day.busiestHour': { en: 'Busiest hour', ar: 'أكثر الساعات ازدحاماً' },
  'perf.day.hoursWithTraffic': { en: 'Hours with traffic', ar: 'ساعات بها حركة' },
